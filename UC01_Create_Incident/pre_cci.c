# 1 "c:\\users\\student\\xdesk\\uc01_create_incident\\\\combined_UC01_Create_Incident.c"
...
# 1 "c:\\users\\student\\xdesk\\uc01_create_incident\\\\combined_UC01_Create_Incident.c" 2
...
# 2 "c:\\users\\student\\xdesk\\uc01_create_incident\\\\combined_UC01_Create_Incident.c" 2
...
# 3 "c:\\users\\student\\xdesk\\uc01_create_incident\\\\combined_UC01_Create_Incident.c" 2
...
# 4 "c:\\users\\student\\xdesk\\uc01_create_incident\\\\combined_UC01_Create_Incident.c" 2
...
Login()
{
	...
	lr_end_transaction("UC01_CI02_Login",2);

	return 0;
}
# 5 "c:\\users\\student\\xdesk\\uc01_create_incident\\\\combined_UC01_Create_Incident.c" 2
...
Action()
{
	...
	lr_end_transaction("UC01_CI04_Location",2);
	...
	lr_end_transaction("UC01_CI05_Theme",2);
	...
	lr_end_transaction("UC01_CI06_Change_Theme",2);
	...
	lr_end_transaction("UC01_CI07_Inventory",2);
	...
	lr_end_transaction("UC01_CI08_Create_inc_and_add_description",2);
	...
	lr_end_transaction("UC01_CI09_Confirm",2);

	lr_think_time(ThinkTime);

	return 0;
}
# 6 "c:\\users\\student\\xdesk\\uc01_create_incident\\\\combined_UC01_Create_Incident.c" 2
...
Logout()
{
	...
	lr_end_transaction("UC01_CI010_Logout",2);
	
	return 0;
}
# 7 "c:\\users\\student\\xdesk\\uc01_create_incident\\\\combined_UC01_Create_Incident.c" 2
...
# 8 "c:\\users\\student\\xdesk\\uc01_create_incident\\\\combined_UC01_Create_Incident.c" 2
