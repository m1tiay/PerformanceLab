# 1 "c:\\users\\student\\xdesk\\uc04_close_task\\\\combined_UC04_Close_Task.c"
...
# 1 "c:\\users\\student\\xdesk\\uc04_close_task\\\\combined_UC04_Close_Task.c" 2
...
# 2 "c:\\users\\student\\xdesk\\uc04_close_task\\\\combined_UC04_Close_Task.c" 2
...
# 3 "c:\\users\\student\\xdesk\\uc04_close_task\\\\combined_UC04_Close_Task.c" 2
...
# 4 "c:\\users\\student\\xdesk\\uc04_close_task\\\\combined_UC04_Close_Task.c" 2
...
Login()
{
	...
	lr_end_transaction("UC03_CT02_Login",2);
	
	return 0;
}
# 5 "c:\\users\\student\\xdesk\\uc04_close_task\\\\combined_UC04_Close_Task.c" 2
...
Action()
{
	...
	lr_end_transaction("UC04_CT03_Select_Tasks",2);
	...
	lr_end_transaction("UC04_CT04_Choose_Task",2);
	...
	lr_end_transaction("UC04_CT05_To_the_Incident",2);
	...
	lr_end_transaction("UC04_CT06_Close_Incident",2);

	return 0;
}
# 6 "c:\\users\\student\\xdesk\\uc04_close_task\\\\combined_UC04_Close_Task.c" 2
...
Logout()
{
	...
	lr_end_transaction("UC03_CT06_Logout",2);
	
	return 0;
}
# 7 "c:\\users\\student\\xdesk\\uc04_close_task\\\\combined_UC04_Close_Task.c" 2
...
# 8 "c:\\users\\student\\xdesk\\uc04_close_task\\\\combined_UC04_Close_Task.c" 2
